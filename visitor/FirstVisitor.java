...
public class FirstVisitor extends GJDepthFirst<String, String>{
    ...
    public String visit(ClassExtendsDeclaration n, String argu) throws Exception {
        ...
        for(String mkey : methodkeySet){
            ...
            st.classes.get(classname).methods.get(mkey).offset = st.classes.get(parent_classname).methods.get(mkey).offset;
        }
        ...
        for(String fkey : fieldkeySet){
            ...
            st.classes.get(classname).fields.get(fkey).offset = st.classes.get(parent_classname).fields.get(fkey).offset;
        }
